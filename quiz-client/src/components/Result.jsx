...
export default function Result() {
    ...
    // Compare the correct answer with the selected answer and add up the accumulated score
    const calculateScore = (qna) => {
        let tempScore = qna.reduce((acc, curr) => {
            return parseInt(curr.answer) === parseInt(curr.selected)
                ? acc + 1
                : acc;
        }, 0);
        setScore(tempScore);
            ...
            >
                ...
                >
                    <CardContent sx={{ flex: "1 0 auto", textAlign: "center" }}>
                        <Typography variant="h4">Congragulations!</Typography>
